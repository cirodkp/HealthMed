...
namespace HealthMed.API.Controllers
{
    ...
    [ApiController]
    public class DoctorTokenController(IAuthenticationDoctorService authenticationService) : ControllerBase
    {
        private readonly IAuthenticationDoctorService _authenticationService = authenticationService;
