...
namespace HealthMed.API.Controllers
{
    ...
    [ApiController]
    public class PatientTokenController(IAuthenticationPatientService authenticationService) : ControllerBase
    {
        private readonly IAuthenticationPatientService _authenticationService = authenticationService;
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] PatientAuthenticationCommand command)
        {
            try
            {
